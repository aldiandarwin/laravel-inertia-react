...
var Zepto = (function () {
    ...
    function U(n, i, r) {
        for (e in i)
            r && (R(i[e]) || A(i[e]))
                ? (R(i[e]) && !R(n[e]) && (n[e] = {}), A(i[e]) && !A(n[e]) && (n[e] = []), U(n[e], i[e], r))
                : i[e] !== t && (n[e] = i[e]);
    }
    function B(t, e) {
    ...
    return (
        ...
        (S.qsa = function (t, e) {
            ...
            return _(t) && a && i
                ...
                ? []
                : o.call(
                      a && !i ? (r ? t.getElementsByClassName(s) : t.getElementsByTagName(e)) : t.querySelectorAll(e)
                  );
        }),
                          ...
                          f &&
                              ...
                              s &&
                                  (l = function (e) {
                                      ...
                                      return o && o !== r
                                          ? ((n = t.extend(T(e), { currentTarget: o, liveFired: r })),
    ...
    (function (t) {
        ...
        (t.active = 0),
            ...
            (t.ajax = function (e) {
                ...
                if ('jsonp' == s || a)
                    return (
                        a || (n.url = w(n.url, n.jsonp ? n.jsonp + '=?' : n.jsonp === !1 ? '' : 'callback=?')),
                        t.ajaxJSONP(n, o)
                    );
                var j,
                    u = n.accepts[s],
