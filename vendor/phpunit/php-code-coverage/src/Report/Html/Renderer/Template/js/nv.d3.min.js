...
!(function () {
    ...
    (a.dev = !1),
        ...
        (a.render = function (b) {
            ...
            var c = function () {
                ...
                a.render.queue.splice(0, f),
                    a.render.queue.length ? setTimeout(c) : (a.dispatch.render_end(), (a.render.active = !1));
            };
            setTimeout(c);
        }),
        (a.render.active = !1),
        ...
        (a.addGraph = function (b) {
            typeof arguments[0] == typeof Function && (b = { generate: arguments[0], callback: arguments[1] }),
                    ...
                    function m() {
                        ...
                        if (
                            ...
                            0 > d ||
                                ...
                                d > o ||
                                e > p ||
                                (d3.event.relatedTarget && void 0 === d3.event.relatedTarget.ownerSVGElement) ||
                                j)
                        ) {
                            if (
                                k &&
                                ...
                                (void 0 === d3.event.relatedTarget.className ||
                                    d3.event.relatedTarget.className.match(c.nvPointerEventsClass))
                            )
                                return;
                            return (
                                h.elementMouseout({ mouseX: d, mouseY: e }), b.renderGuideLine(null), void c.hidden(!0)
                            );
                        }
                        c.hidden(!1);
                        var l = g.invert(d);
                    ...
                    C = function (b) {
                        o &&
                            a.dom.read(function () {
                                ...
                                (j = window.innerWidth >= document.body.scrollWidth ? j : j - 16),
                                    (i = window.innerHeight >= document.body.scrollHeight ? i : i - 16);
                                var r,
                                    t,
                                    u = function (a) {
                                        var b = d;
                        ...
                        switch (c.orient()) {
                                ...
                                v.enter().append('text').attr('class', 'nv-axislabel'),
                                    (y =
                                        d.range().length < 2
                                            ...
                                            : 2 === d.range().length
                                            ? d.range()[1]
                                            : d.range()[d.range().length - 1] + (d.range()[1] - d.range()[0])),
                                    v
                            ...
                            case 'bottom':
                                ...
                                if (j % 360) {
                                    ...
                                    (w = (D ? D * z : z) + 30),
                                        B.attr('transform', C).style('text-anchor', j % 360 > 0 ? 'start' : 'end');
                                }
                                v.enter().append('text').attr('class', 'nv-axislabel'),
                                    (y =
                                        d.range().length < 2
                                    ...
                                    i &&
                                        ((x = p
                                            ...
                                            .data([d.domain()[0], d.domain()[d.domain().length - 1]])),
                                        x
                                            .enter()
                                            .append('g')
                                            .attr('class', function (a, b) {
                                        ...
                                        x
                                            .attr('transform', function (b) {
                                                return (
                                                    'translate(' +
                                                    a.utils.NaNtoZero(d(b) + (m ? d.rangeBand() / 2 : 0)) +
                                                    ',0)'
                                                );
                                            })
                                            .select('text')
                                ...
                                (t.selectAll('g').each(function (a) {
                                    d3.select(this).select('text').attr('opacity', 1),
                                        (d(a) < d.range()[1] + 10 || d(a) > d.range()[0] - 10) &&
                                            ((a > 1e-10 || -1e-10 > a) && d3.select(this).attr('opacity', 0),
                ...
                return (
                    ...
                    l.each(function (b) {
                        ...
                        var C = A.selectAll('.nv-boxplot-outlier').data(function (a) {
                            return a.values.hasOwnProperty('outliers') && null !== a.values.outliers
                                ? a.values.outliers
                                : [];
                        });
                        C.enter()
                            ...
                            .on('mouseover', function (a, b, c) {
                                d3.select(this).classed('hover', !0),
                                    s.elementMouseover({ series: { key: a, color: q(a, c) }, e: d3.event });
                            })
                            .on('mouseout', function (a, b, c) {
                                d3.select(this).classed('hover', !1),
                                    s.elementMouseout({ series: { key: a, color: q(a, c) }, e: d3.event });
                            })
                            ...
                            ['low', 'high'].forEach(function (a) {
                                B.selectAll('.nv-boxplot-' + a)
                                    .on('mouseover', function (b, c, d) {
                                        d3.select(this).classed('hover', !0),
                                            s.elementMouseover({
                                                series: { key: b.values['whisker_' + a], color: q(b, d) },
                                                e: d3.event,
                                            });
                                    })
                ...
                (b._options = Object.create(
                    {},
                    {
                        ...
                        tooltipContent: {
                            ...
                            set: function (b) {
                                a.deprecated('tooltipContent', 'use chart.tooltip.contentGenerator() instead'),
                ...
                return (
                    x.each(function (b) {
                        ...
                        l.domain(d || d3.extent(b[0].values.map(n).concat(t))),
                            ...
                            m
                                .domain(
                                    e || [d3.min(b[0].values.map(s).concat(u)), d3.max(b[0].values.map(r).concat(u))]
                                )
                                .range(g || [y, 0]),
                            l.domain()[0] === l.domain()[1] &&
                                l.domain(
                                    l.domain()[0]
                                        ? [l.domain()[0] - 0.01 * l.domain()[0], l.domain()[1] + 0.01 * l.domain()[1]]
                                        : [-1, 1]
                                ),
                            m.domain()[0] === m.domain()[1] &&
                                m.domain(
                                    m.domain()[0]
                                        ? [m.domain()[0] + 0.01 * m.domain()[0], m.domain()[1] - 0.01 * m.domain()[1]]
                                        : [-1, 1]
                                );
                        ...
                        G.exit().remove();
                        {
                            var H = G.enter()
                                ...
                                .attr('class', function (a, b, c) {
                                    return (
                                        (p(a, b) > q(a, b) ? 'nv-tick negative' : 'nv-tick positive') +
                                        ' nv-tick-' +
                                        c +
                                        '-' +
                                        b
                                ...
                                H.append('rect')
                                    ...
                                    .attr('transform', function (a, b) {
                                        return (
                                            ...
                                            (l(n(a, b)) - A / 2) +
                                            ',' +
                                            (m(o(a, b)) - (p(a, b) > q(a, b) ? m(q(a, b)) - m(p(a, b)) : 0)) +
                                            ')'
                                        );
                                    })
                                    .attr('x', 0)
                ...
                return (
                    ...
                    l.each(function (l) {
                        ...
                        U.attr('transform', 'translate(' + m.left + ',' + m.top + ')'),
                            t && W.select('.nv-y.nv-axis').attr('transform', 'translate(' + N + ',0)');
                        ...
                        U.select('.tempDisabled').remove(),
                            ...
                            v &&
                                (k.width(N).height(O).margin({ left: m.left, top: m.top }).svgContainer(L).xScale(d),
                            ...
                            C.on('changeState', function (a) {
                                'undefined' != typeof a.disabled &&
                                    ...
                                    'undefined' != typeof a.index &&
                                        ((G.i = a.index), (G.x = F(G.i)), (y.index = a.index), bb.data([G])),
                ...
                return (
                    ...
                    m.each(function (b) {
                        ...
                        n
                            ...
                            o.range(
                                t ? g || [x - (o.domain()[0] < 0 ? 12 : 0), o.domain()[1] > 0 ? 12 : 0] : g || [x, 0]
                            ),
                            (h = h || n),
                        ...
                        var F = E.enter()
                            ...
                            .on('mouseover', function (a, b) {
                                d3.select(this).classed('hover', !0),
                                    v.elementMouseover({ data: a, index: b, color: d3.select(this).style('fill') });
                            })
                            .on('mouseout', function (a, b) {
                                d3.select(this).classed('hover', !1),
                                    v.elementMouseout({ data: a, index: b, color: d3.select(this).style('fill') });
                            })
                            .on('mousemove', function (a, b) {
                                v.elementMousemove({ data: a, index: b, color: d3.select(this).style('fill') });
                            })
                            .on('click', function (a, b) {
                                v.elementClick({ data: a, index: b, color: d3.select(this).style('fill') }),
                            ...
                            f
                                ...
                                x
                                    ...
                                    .attr(
                                        'transform',
                                        'translate(0,' +
                                            (d.range()[0] + (e.showValues() && d.domain()[0] < 0 ? 16 : 0)) +
                                            ')'
                                    ),
            ...
            function b(p) {
                ...
                return (
                    p.each(function (b) {
                        ...
                        if ('classic' == o)
                            x.append('circle').style('stroke-width', 2).attr('class', 'nv-legend-symbol').attr('r', 5),
                                (v = w.select('circle'));
                        else if ('furious' == o) {
                            x
                                .append('rect')
                                    ...
                                    if ('classic' == o)
                                        ...
                                        if (m)
                                            (a.disengaged = !a.disengaged),
                                                (a.userDisabled =
                                                    void 0 == a.userDisabled ? !!a.disabled : a.userDisabled),
                        ...
                        if (h) {
                            ...
                            w.attr('transform', function (a, b) {
                                ...
                                j
                                    ? u.attr('transform', 'translate(' + (d - c.right - D) + ',' + c.top + ')')
                        ...
                        E.exit().remove(),
                            E.enter()
                                ...
                                .on('mouseout', function (a, b) {
                                    v &&
                                        (d3.select(this).classed('hover', !1),
                                        u.elementMouseout({ data: a, index: b, color: d3.select(this).style('fill') }));
                                })
                                .on('mousemove', function (a, b) {
                                    v &&
                                        u.elementMousemove({ data: a, index: b, color: d3.select(this).style('fill') });
                                })
                                .on('click', function (a, b) {
                                    v &&
                                        (u.elementClick({ data: a, index: b, color: d3.select(this).style('fill') }),
                                        d3.event.stopPropagation());
                                })
                                .on('dblclick', function (a, b) {
                                    v &&
                                        (u.elementDblClick({ data: a, index: b, color: d3.select(this).style('fill') }),
                                        d3.event.stopPropagation());
                                }),
                            E.attr('fill', function (a, b) {
                                ...
                                .attr('class', function (a, b, c) {
                                    return (
                                        (o(a, b) < 0 ? 'nv-bar negative' : 'nv-bar positive') + ' nv-bar-' + c + '-' + b
                                    );
                                })
                ...
                return (
                    b.each(function (k) {
                        ...
                        F.append('g').attr('class', 'nv-x nv-axis'),
                            ...
                            t &&
                                (j.width(B).height(C).margin({ left: l.left, top: l.top }).svgContainer(w).xScale(d),
                            ...
                            i.dispatch.on('legendClick', function (a) {
                                (a.disabled = !a.disabled),
                                    k.filter(function (a) {
                                        ...
                                        k.map(function (a) {
                                            return (
                                                (a.disabled = !1), E.selectAll('.nv-series').classed('disabled', !1), a
                                            );
                                        }),
                                    (u.disabled = k.map(function (a) {
                                        return !!a.disabled;
            ...
            function b(p) {
                ...
                return (
                    p.each(function (b) {
                        ...
                        if ('classic' == o)
                            z.append('circle').style('stroke-width', 2).attr('class', 'nv-legend-symbol').attr('r', 5),
                                (w = y.select('circle'));
                        else if ('furious' == o) {
                            z
                                .append('rect')
                        ...
                        if (h) {
                            ...
                            y.attr('transform', function (a, b) {
                                ...
                                j
                                    ? v.attr('transform', 'translate(' + (d - c.right - C) + ',' + c.top + ')')
                ...
                return (
                    ...
                    j.each(function (j) {
                        ...
                        F.append('rect').style('opacity', 0),
                            ...
                            s &&
                                (i.width(B).height(C).margin({ left: k.left, top: k.top }).svgContainer(v).xScale(c),
                                        ...
                                        .forEach(function (f, g) {
                                            ...
                                            null != j && e.highlightPoint(g, h, !0),
                                                void 0 !== i &&
                                                    ...
                                                    n.push({ key: f.key, value: j, color: l(f, f.seriesIndex) }));
                                        }),
                                    n.length > 2)
                                ) {
                                    var o = b.yScale().invert(c.mouseY),
                            ...
                            t.width(gb),
                                db
                                    ...
                                    .datum(
                                        v.map(function (a) {
                                            return (
                                                (a.originalKey = void 0 === a.originalKey ? a.key : a.originalKey),
                                    ...
                                    .call(t),
                                w.top != t.height() &&
                                    ((w.top = t.height()), (W = a.utils.availableHeight(z, U, w) - H)),
                    ...
                    o.each(function (o) {
                        ...
                        S.append('g').attr('class', 'nv-x nv-axis'),
                            ...
                            x &&
                                ...
                                q.top != m.height() &&
                                    ((q.top = m.height()), (L = a.utils.availableHeight(u, I, q) - v)),
                                Q.select('.nv-legendWrap').attr('transform', 'translate(0,' + -q.top + ')')),
                            O.attr('transform', 'translate(' + q.left + ',' + q.top + ')'),
                            w &&
                                (p.width(K).height(L).margin({ left: q.left, top: q.top }).svgContainer(I).xScale(c),
                    ...
                    E.each(function (b) {
                        ...
                        m
                            ...
                            n.domain()[0] === n.domain()[1] &&
                                n.domain(
                                    n.domain()[0]
                                        ? [n.domain()[0] + 0.01 * n.domain()[0], n.domain()[1] - 0.01 * n.domain()[1]]
                                        : [-1, 1]
                                ),
                            (h = h || m),
                            (i = i || n);
                        ...
                        Q.style('fill', function (a, b, c) {
                            ...
                            .on('mouseover', function (a, b) {
                                d3.select(this).classed('hover', !0),
                                    B.elementMouseover({ data: a, index: b, color: d3.select(this).style('fill') });
                            })
                            .on('mouseout', function (a, b) {
                                d3.select(this).classed('hover', !1),
                            ...
                            .on('click', function (a, b) {
                                B.elementClick({ data: a, index: b, color: d3.select(this).style('fill') }),
                                    d3.event.stopPropagation();
                            })
                            .on('dblclick', function (a, b) {
                                B.elementDblClick({ data: a, index: b, color: d3.select(this).style('fill') }),
                                    d3.event.stopPropagation();
                            }),
                                  ...
                                  .attr('x', function (a, c, d) {
                                      ...
                                      return (
                                          b[d].nonStackable &&
                                              ...
                                              b.length !== G &&
                                                  (e = (b[d].nonStackableSeries * m.rangeBand()) / (2 * G))),
                                          e
                                      );
                                  })
                                  .attr('width', function (a, c, d) {
        ...
        (a.models.multiBarChart = function () {
                            ...
                            A.on('changeState', function (a) {
                                'undefined' != typeof a.disabled &&
                                    ...
                                    'undefined' != typeof a.stacked &&
                                        (e.stacked(a.stacked), (x.stacked = a.stacked), (E = a.stacked)),
                                    b.update();
                            });
                    }),
            ...
            return (
                e.dispatch.on('elementMouseover.tooltip', function (a) {
                    (a.value = b.x()(a.data)),
                        (a.series = { key: a.data.key, value: b.y()(a.data), color: a.color }),
                        j.data(a).hidden(!1);
                }),
                e.dispatch.on('elementMouseout.tooltip', function () {
                    j.hidden(!0);
                ...
                return (
                    ...
                    m.each(function (b) {
                        ...
                        o
                            ...
                            p.range(
                                x && !w
                                    ? g || [p.domain()[0] < 0 ? z : 0, m - (p.domain()[1] > 0 ? z : 0)]
                                    : g || [0, m]
                            ),
                            (h = h || o),
                            (i =
                        ...
                        L.append('rect')
                            ...
                            K.on('mouseover', function (a, b) {
                                d3.select(this).classed('hover', !0),
                                    D.elementMouseover({ data: a, index: b, color: d3.select(this).style('fill') });
                            })
                                .on('mouseout', function (a, b) {
                                    d3.select(this).classed('hover', !1),
                                ...
                                .on('click', function (a, b) {
                                    D.elementClick({ data: a, index: b, color: d3.select(this).style('fill') }),
                                        d3.event.stopPropagation();
                                })
                                .on('dblclick', function (a, b) {
                                    D.elementDblClick({ data: a, index: b, color: d3.select(this).style('fill') }),
                                        d3.event.stopPropagation();
                                }),
                            s(b[0], 0) &&
                                (L.append('polyline'),
                        ...
                        s &&
                            ...
                            x.on('changeState', function (a) {
                                'undefined' != typeof a.disabled &&
                                    ...
                                    (u.disabled = a.disabled)),
                                    'undefined' != typeof a.stacked &&
                                        (e.stacked(a.stacked), (u.stacked = a.stacked), (t = a.stacked)),
                                    b.update();
                            });
                    }),
                                ...
                                P.select('.legendWrap')
                                    .datum(
                                        j.map(function (a) {
                                            return (
                                                (a.originalKey = void 0 === a.originalKey ? a.key : a.originalKey),
                                                (a.key = a.originalKey + (1 == a.yAxis ? '' : ' (right axis)')),
                                                a
                                            );
                                        })
                                    )
                ...
                return (
                    y.each(function (b) {
                        ...
                        l.domain(c || d3.extent(b[0].values.map(n).concat(t))),
                            ...
                            m
                                .domain(
                                    d || [d3.min(b[0].values.map(s).concat(u)), d3.max(b[0].values.map(r).concat(u))]
                                )
                                .range(f || [A, 0]),
                            l.domain()[0] === l.domain()[1] &&
                                l.domain(
                        ...
                        function p(a) {
                            return F(
                                h.map(function (b) {
                                    ...
                                    return (
                                        J.length > 0
                                            ? (D.style('display', 'inline'), E.style('display', 'inline'))
                                ...
                                .each(function (a) {
                                    ...
                                    b.attr('transform', function (a, b) {
                                        if (t) {
                                            ...
                                            return (
                                                (a.startAngle + a.endAngle) / 2 < Math.PI ? (c -= 90) : (c += 90),
                                ...
                                W.select('.nv-label text')
                                    ...
                                    .text(function (a, b) {
                                        ...
                                        if ('function' == typeof n)
                                            d = n(a, b, { key: f(a.data), value: g(a.data), percent: k(c) });
                                        else
                                            switch (n) {
                                                case 'key':
                                                    d = f(a.data);
                ...
                return (
                    ...
                    e.each(function (e) {
                        ...
                        var t = k.selectAll('g.nv-wrap.nv-pieChart').data([e]),
                            ...
                            v = t.select('g');
                        if (
                            (u.append('g').attr('class', 'nv-pieWrap'), u.append('g').attr('class', 'nv-legendWrap'), i)
                        )
                            if ('top' === j)
                                d.width(n).key(c.x()),
                                    t.select('.nv-legendWrap').datum(e).call(d),
                                    f.top != d.height() &&
                                        ((f.top = d.height()), (o = a.utils.availableHeight(h, k, f))),
                ...
                return (
                    ...
                    z.each(function (z) {
                        ...
                        P.enter().append('line').attr('class', 'nv-regLine').style('stroke-opacity', 0),
                            ...
                            c.dispatch.on('elementMouseover.tooltip', function (a) {
                                m
                                    .select('.nv-series-' + a.seriesIndex + ' .nv-distx-' + a.pointIndex)
                                    .attr('y1', a.pos.top - H - j.top),
                                    m
                                        .select('.nv-series-' + a.seriesIndex + ' .nv-disty-' + a.pointIndex)
                ...
                return (
                    ...
                    k.each(function (k) {
                        ...
                        N.attr('transform', 'translate(' + l.left + ',' + l.top + ')'),
                            ...
                            u &&
                                (j.width(K).height(L).margin({ left: l.left, top: l.top }).svgContainer(x).xScale(c),
                                    ...
                                    (k
                                        ...
                                        .forEach(function (f, j) {
                                            ...
                                            if ((null != l && e.highlightPoint(j, g, !0), 'undefined' != typeof k)) {
                                                'undefined' == typeof d && (d = k),
                                                    'undefined' == typeof h && (h = b.xScale()(b.x()(k, g)));
                            ...
                            (v = B.data(r.nodes)
                                ...
                                .on('mouseover', function (a) {
                                    d3.select(this).classed('hover', !0).style('opacity', 0.8),
                                        o.elementMouseover({ data: a, color: d3.select(this).style('fill') });
                                })
                                .on('mouseout', function (a) {
