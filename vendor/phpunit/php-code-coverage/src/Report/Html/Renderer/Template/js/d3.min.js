!(function () {
    ...
    function Ft(n, t, e, r) {
        ...
        return xo(o) > Uo
            ? Math.atan(
                  (Math.sin(t) * (u = Math.cos(r)) * Math.sin(e) - Math.sin(r) * (i = Math.cos(t)) * Math.sin(n)) /
                      (i * u * o)
              )
            : (t + r) / 2;
    }
    ...
    function He(n) {
        ...
        if ((ol.insert(t, l), t || e)) {
            if (t === e)
                return (
                    Be(t), (e = Ue(t.site)), ol.insert(l, e), (l.edge = e.edge = Ke(t.site, l.site)), $e(t), void $e(e)
                );
    ...
    function Ni(n) {
        ...
        if ((e = n.children) && (c = e.length)) {
            ...
            if (
                ...
                for (
                    u = e[2], zi(r, i, u), t(u), wi(r, u), r._pack_prev = u, wi(u, i), i = r._pack_next, o = 3;
                    c > o;
                    o++
                ) {
                    zi(r, i, (u = e[o]));
    ...
    function Xi(n, t) {
        var e,
            ...
            o = n[i];
        return (
            u > o && ((e = r), (r = i), (i = e), (e = u), (u = o), (o = e)), (n[r] = t.floor(u)), (n[i] = t.ceil(o)), n
        );
    }
    function $i(n) {
        return n
    ...
    function Qu(n, t, e, r, i) {
        ...
        v ||
            ...
            (f = qn(u, 0, l)),
            (v = g[r] =
                { tween: new c(), time: l, timer: f, delay: i.delay, duration: i.duration, ease: i.ease, index: t }),
            (i = null),
            ++g.count);
    }
    function no(n, t, e) {
                    ...
                    if (Fo > h) {
                        var D = null == S ? [_, w] : null == x ? [m, M] : Re([m, M], [S, k], [x, b], [_, w]),
                            ...
                            H =
                                1 /
                                Math.sin(
                                    Math.acos((P * j + U * F) / (Math.sqrt(P * P + U * U) * Math.sqrt(j * j + F * F))) /
                                        2
                                ),
